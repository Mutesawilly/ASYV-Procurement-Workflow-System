...
import { Printer, Download, ArrowLeft, Eye, Edit, DollarSign, Calendar, User, FileText, Package } from "lucide-react"
                            ...
                            {(requestData.stage === "STA_EMPLOYEE" || requestData.stage === "STA_STOREKEEPER") ? (
                                (requestData.stage === "STA_EMPLOYEE") ? (
                                    ...
                                    <>
                                        ...
                                        <Button className={"cursor-pointer hover:bg-gray-600 active:bg-green-900 duration-500 ease-in-out"} onClick={async () => approveRequest(requestData)}>
                                            Approve Request
                                        </Button>
                                    </>
                                )
